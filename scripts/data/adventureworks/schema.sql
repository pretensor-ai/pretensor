-- AdventureWorks-for-Postgres schema — DDL only.
-- Source: https://github.com/lorint/AdventureWorks-for-Postgres (MIT license),
--   commit upstream/master of install.sql. Data loads (\copy), progress markers
--   (SELECT 'Copying data into ...'), the inline Production.ProductReview INSERT,
--   the Türkiye UPDATE fix, and psql meta-commands (\pset, \dt) have been
--   stripped. All DDL including CREATE DOMAIN, CREATE SCHEMA, CREATE TABLE,
--   ALTER TABLE ADD CONSTRAINT, CREATE INDEX, CREATE VIEW, and CREATE FUNCTION
--   is retained.
--
-- To regenerate tests/fixtures/schemas/adventureworks.yaml from this file:
...
-- NOTE: Adapted for contrib-free Postgres 16:
--   * CREATE EXTENSION lines stripped (uuid-ossp, tablefunc not required).
--   * uuid_generate_v1() replaced with gen_random_uuid() (Postgres 13+ core).
--   * Sales.vSalesPersonSalesByFiscalYears view dropped (needs tablefunc).
--
...
-- (CREATE EXTENSION stripped for contrib-free Postgres)
...
CREATE SCHEMA Person
  CREATE TABLE BusinessEntity(
    ...
    rowguid uuid NOT NULL CONSTRAINT "DF_BusinessEntity_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE Person(
    ...
    rowguid uuid NOT NULL CONSTRAINT "DF_Person_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE StateProvince(
    ...
    rowguid uuid NOT NULL CONSTRAINT "DF_StateProvince_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE Address(
    ...
    rowguid uuid NOT NULL CONSTRAINT "DF_Address_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
    ModifiedDate TIMESTAMP NOT NULL CONSTRAINT "DF_Address_ModifiedDate" DEFAULT (NOW())
  )
  CREATE TABLE AddressType(
    AddressTypeID SERIAL,
    Name "Name" NOT NULL,
    rowguid uuid NOT NULL CONSTRAINT "DF_AddressType_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE BusinessEntityAddress(
    ...
    rowguid uuid NOT NULL CONSTRAINT "DF_BusinessEntityAddress_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE BusinessEntityContact(
    ...
    rowguid uuid NOT NULL CONSTRAINT "DF_BusinessEntityContact_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE EmailAddress(
    ...
    rowguid uuid NOT NULL CONSTRAINT "DF_EmailAddress_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE Password(
    ...
    rowguid uuid NOT NULL CONSTRAINT "DF_Password_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
...
CREATE SCHEMA HumanResources
  ...
  CREATE TABLE Employee(
    ...
    rowguid uuid NOT NULL CONSTRAINT "DF_Employee_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
...
CREATE SCHEMA Production
  ...
  CREATE TABLE Document(
    ...
    rowguid uuid NOT NULL UNIQUE CONSTRAINT "DF_Document_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE ProductCategory(
    ...
    Name "Name" NOT NULL,
    rowguid uuid NOT NULL CONSTRAINT "DF_ProductCategory_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE ProductSubcategory(
    ...
    Name "Name" NOT NULL,
    rowguid uuid NOT NULL CONSTRAINT "DF_ProductSubcategory_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE ProductModel(
    ...
    rowguid uuid NOT NULL CONSTRAINT "DF_ProductModel_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE Product(
    ...
    rowguid uuid NOT NULL CONSTRAINT "DF_Product_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE ProductDescription(
    ...
    rowguid uuid NOT NULL CONSTRAINT "DF_ProductDescription_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE ProductInventory(
    ...
    rowguid uuid NOT NULL CONSTRAINT "DF_ProductInventory_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
...
ALTER TABLE Production.ProductDocument ADD rowguid uuid NOT NULL CONSTRAINT "DF_ProductDocument_rowguid" DEFAULT (gen_random_uuid());
-- Convert from all the hex to a stream of hierarchyid bits
WITH RECURSIVE hier AS (
  SELECT rowguid, doc, get_byte(decode(substring(doc, 1, 2), 'hex'), 0)::bit(8)::varchar AS bits, 2 AS i
...
CREATE SCHEMA Purchasing
  ...
  CREATE TABLE ShipMethod(
    ...
    rowguid uuid NOT NULL CONSTRAINT "DF_ShipMethod_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
...
CREATE SCHEMA Sales
  ...
  CREATE TABLE Customer(
    ...
    rowguid uuid NOT NULL CONSTRAINT "DF_Customer_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE SalesOrderDetail(
    ...
    rowguid uuid NOT NULL CONSTRAINT "DF_SalesOrderDetail_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE SalesOrderHeader(
    ...
    rowguid uuid NOT NULL CONSTRAINT "DF_SalesOrderHeader_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE SalesPerson(
    ...
    rowguid uuid NOT NULL CONSTRAINT "DF_SalesPerson_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE SalesPersonQuotaHistory(
    ...
    rowguid uuid NOT NULL CONSTRAINT "DF_SalesPersonQuotaHistory_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE SalesTaxRate(
    ...
    Name "Name" NOT NULL,
    rowguid uuid NOT NULL CONSTRAINT "DF_SalesTaxRate_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE SalesTerritory(
    ...
    rowguid uuid NOT NULL CONSTRAINT "DF_SalesTerritory_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE SalesTerritoryHistory(
    ...
    StartDate TIMESTAMP NOT NULL,
    EndDate TIMESTAMP NULL,
    rowguid uuid NOT NULL CONSTRAINT "DF_SalesTerritoryHistory_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE SpecialOffer(
    ...
    MaxQty INT NULL,
    rowguid uuid NOT NULL CONSTRAINT "DF_SpecialOffer_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE SpecialOfferProduct(
    SpecialOfferID INT NOT NULL,
    ProductID INT NOT NULL,
    rowguid uuid NOT NULL CONSTRAINT "DF_SpecialOfferProduct_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
  ...
  CREATE TABLE Store(
    ...
    rowguid uuid NOT NULL CONSTRAINT "DF_Store_rowguid" DEFAULT (gen_random_uuid()), -- ROWGUIDCOL
...
-- (VIEW Sales.vSalesPersonSalesByFiscalYears stripped — requires tablefunc contrib extension)
...
-- NOTE: The upstream install.sql defines five "convenience" schemas
-- (pe, hr, pr, pu, sa) that expose short-aliased views over the five main
-- schemas (person, humanresources, production, purchasing, sales). Those
-- alias views are stripped here — they add no schema knowledge that the
-- benchmark cares about and would triple the fixture YAML size.
